...
parser.add_argument('--data-path', default='/PATH_TO_RadGraph/RadGraph/physionet.org/files/radgraph/1.0.0/MIMIC-CXR_graphs.json',
                    help='RadGraph data path.'
                    )
parser.add_argument('--output-path', default='./preprocessing/mimic-cxr-radgraph-itemized.csv',
